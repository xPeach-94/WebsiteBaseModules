...
const createSlideshowElements = function(index, height, useDots)
{
    ...
    {
        // Dots
        slideshow.classList.add("slideShowDots");
...
for (let i = 1; i <= 100; i++) 
{
    if (document.getElementById("slideshow" + i) != null && i <= imgSrcs.length) 
    {
        createSlideshowElements(i, slideShowHeight[i-1], useDots[i-1]);
    }
    else
    {
        break;
